...
adv_req_num,
adv_iss_num,
if(adv_req_num = 0,0,adv_iss_num/adv_req_num) as iss_req_rate,
adv_show_num,
if(adv_iss_num = 0,0,adv_show_num/adv_iss_num) as show_iss_rate,
adv_cli_num,
if(adv_show_num = 0,0,adv_cli_num/adv_show_num) as cli_show_rate
-- ,201911,29
